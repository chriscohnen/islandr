...
class DiscoveryScannerTest {
    ...
    void returnsLiveHostsInNumericIpOrderWithTypeGuess() {
        ...
        Function<String, HostProbe.ProbeResult> fake = ip -> switch (ip) {
            case "10.0.0.2"  -> new HostProbe.ProbeResult(ip, true, List.of(554), "cam-host");  // camera
            case "10.0.0.10" -> new HostProbe.ProbeResult(ip, true, List.of(22), null);         // computer
            default          -> new HostProbe.ProbeResult(ip, false, List.of(), null);          // dead
        };
    ...
    void skipsHostsWhoseProbeThrows() {
        Function<String, HostProbe.ProbeResult> fake = ip -> {
            ...
            return new HostProbe.ProbeResult(ip, true, List.of(80), null);
        };
    ...
    void reportsProgressOncePerHost_includingDeadOnes() {
        ...
        Function<String, HostProbe.ProbeResult> fake = ip -> new HostProbe.ProbeResult(ip, false, List.of(), null);
