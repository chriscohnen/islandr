...
class DashboardResourceTest {
    ...
    void seed() {
        ...
        r2.persist();
        ResourcePort.createNew(r1.id, 3389, "tcp", "RDP", null).persist();
        ResourcePort.createNew(r1.id, 22, "tcp", "SSH", null).persist();
        ResourcePort.createNew(r2.id, 445, "tcp", "SMB", null).persist();
